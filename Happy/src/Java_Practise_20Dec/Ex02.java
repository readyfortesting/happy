...
public static void main(String[] args) {
 ...
 //    arrayList1.retainAll(arrayList2);//Kesiþimi
 ...
 arrayListFark1.removeAll(arrayList2); //1 in 2 den farký
 System.out.println("arrListFark1 = " + arrayListFark1);
         arrayListFark2.removeAll(arrayList1); //2nin 1 den farký
 System.out.println("arrListFark2 = " + arrayListFark2);

 //     arrayListFark1.addAll(arrayListFark2); // Farklarýn birleþimi
 //      System.out.println("arrListFarklarýn birleþimi =" + arrayListFark1);

 Collections.sort(arrayListFark1); // Farkýn sýralanmasý
 System.out.println("Fark1 in sýralanmýþ hali = " + arrayListFark1);

 Collections.reverse(arrayListFark1); // Farkýn tersten yazdýrýlmasý
 System.out.println("Fark2 in sýralanmýþ hali =" + arrayListFark1);
}
...
// list1.retainAll(list2);
 //System.out.println("kesiþen elemanlar : " + list1);//kesiþen elelman verir.
 //  3.  Bu iki list'in farkli olan elemanlarini bulunuz
...
yeniL1=list1;
 ...
 System.out.println("l1 deki farklý elemanlar :" + yeniL1);
 System.out.println("l2 deki farklý elemanlar :" + yeniL2);
 yeniL1.addAll(yeniL2);//l1 ve l2 benzeesiz farklý elemanlrýný l1 e atadýk
 System.out.println("l1 ve l2 deki farklý elemanlar hepsi :" + yeniL1);
}
private static ArrayList<Integer> listCreat(int boyut, int min, int max) {
 ArrayList<Integer> liste = new ArrayList<>();
 for (int i = 0; i < boyut; i++) {
     liste.add((int) (min + Math.random() * (max - min + 1)));// baþladýðýn +rastgelesayý*(bittiðin-baþladýðýn+1)=baþladýðýn ile bittiðin arasýndaki rastgele sayýlar
 }
 return liste;
}
*/
